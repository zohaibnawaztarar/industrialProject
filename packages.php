...
<div class="container">
    ...
    $sql = "SELECT dRGDescription, providerName, providerCity, averageTotalPayments FROM dbo.newDB WHERE providerZipCode LIKE ? AND dRGCode=? AND year=2017";
    ...
    # get first 2 digits of the zipcode given by the user, % is the regular expression (any number of chars can follow)
